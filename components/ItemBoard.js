...
export default class Item extends Component {
  ...
  componentDidMount() {
    const images =[
      ...
      { image_path: 'http://s3-ap-northeast-2.amazonaws.com/demo-lookids/1/item_12.jpg', rank: 4, name:'아이 하루 롱패팅 6색', favor:0, price:47000,  key: '4' },
      ...
      { image_path: 'http://s3-ap-northeast-2.amazonaws.com/demo-lookids/1/item_8.jpg', rank: 6, name: '양털 코트(공용)', price: 67000, key: '6'},
    ];
